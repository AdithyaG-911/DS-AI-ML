...
target_distance=int(input("Enter the distance to the target (in meters): "))
...
while current_distance<target_distance:
    if obstacle=="no":
        ...
        checkpoints.append(f"Move forward {travel} meters in ",speed[random.randint(0,len(speed)-1)])
...
print(f"Toatal distance travelled     :{current_distance} meters")
