# -*- coding: utf-8 -*-
"""
Created on Thu Feb 12 10:12:32 2026
...
#Better to do String Cleaning. Not necessary but if we present data to client in graph.

#1.missing value 2.duplicate 3.remove un-necessary 4.data_type conversion
